import { Container, AppForm, ImageUploader } from "./styles";
...
export function EditProduct() {
  ...
  async function handleSaveDish() {
    ...
    if (!image) {
      return toast.error(
        "É necessário adicionar uma nova imagem para o prato.",
        {
          position: toast.POSITION.TOP_RIGHT
        }
      );
    ...
    if (newIngredient) {
      return toast.error(
        "Você deixou o campo de ingrediente incompleto, finalize ou apague o conteúdo para adicionar o ingrediente.",
        {
          ...
          {data && (
            <main>
              ...
              <footer>
                ...
                <Button title="Salvar prato" onClick={handleSaveDish} />
              </footer>
            </main>
          )}
        </AppForm>
